          ...
          <ul className="navbar-nav me-auto mb-2 mb-lg-0 ">
              ...
              >
                ...
                {Object.keys(stateCityData).map((state, index) => (
                  <optgroup key={index} label={state}>
                    {Object.keys(stateCityData[state]).map(
                      (city, cityIndex) => (
                        <option
                          key={cityIndex}
                          value={`${state}-${city}`}
                          data-latitude={stateCityData[state][city].latitude}
                          data-longitude={stateCityData[state][city].longitude}
                        >
                          {city}
                        </option>
                      )
            ...
            >
              ...
              <button
                ...
                type="submit"
                style={{ backgroundColor: "#85ef57", color: "#015e65" }}
              >
                Search
              </button>
              ...
              >
                ...
                {cartItems.length ? (
                  <i className="bi bi-cart3">
                    {" "}
                    <span
                      className="position-absolute top-3 start-90 translate-middle bg-warning rounded-circle"
                      style={{
                        fontSize: "10px",
                        color: "white",

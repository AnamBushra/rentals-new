...
const CartItem = ({ item }) => {
  ...
  const handleRemove = async () => {
    ...
    try {
      const response = await axios.post(
        "https://rent-n-roam.onrender.com/remove-from-cart",
        { userId, productId }
      );
  ...
  return (
    <div
      className="card2" /*style={{borderTop:"1px solid #f0f0f0",borderRadius:"0px",display:"inline-block"}}*/
    >
      <div className="left2">
        <img
          className="imgg"
      ...
      <div className="box" style={{ margin: "20px", textAlign: "left" }}>
        ...
        <small className="small">Seller:RetailNet</small>

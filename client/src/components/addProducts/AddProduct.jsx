...
function AddProduct() {
  ...
  const handleApi = () => {
    navigator.geolocation.getCurrentPosition((position) => {
      ...
      const url = "https://rent-n-roam.onrender.com/addproduct";
      axios
        .post("https://rent-n-roam.onrender.com/addproduct", formData, {
          headers: {
      ...
      <div className="p-33">
        ...
        >
          ...
          <span>
            ...
            &nbsp; &nbsp;
            <Link to="/catpage" style={{ display: "inline", color: "black" }}>
              {" "}
              <b>
                <u>Change</u>
              </b>

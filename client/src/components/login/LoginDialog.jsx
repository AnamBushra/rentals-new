...
export default function LoginDialog(props) {
  ...
  const signupUser = async (e) => {
    ...
    try {
      setPage("login");
      await axios.post("https://rent-n-roam.onrender.com/signup", signup);
    } catch (err) {
      console.log(err);
    }
  };
  ...
  const LoginUser = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://rent-n-roam.onrender.com/login",
        ...
        {page === "login" ? (
          <div className="flex-container">
            ...
            <div className="rightBox">
              ...
              <form id="form1" style={{ margin: "40px 25px 10px 25px" }}>
                ...
                {error && (
                  <small>
                    <u style={{ textDecoration: "none", color: "red" }}>
          ...
          <div className="flex-container">
            ...
            <div className="rightBox">
              ...
              <form
                id="form2"
                style={{ margin: "40px 25px 10px 25px" }}
                onSubmit={signupUser}
              >
                <div className="form-group" style={{ marginBottom: "8px" }}>
                  <label
